    ...
    try:
        if unique_id in pending_async_nodes:
            ...
            try:
                ...
                node_duration = time.perf_counter() - node_start_time
                comfy.metrics.record_node_execution(class_type, node_duration)
                primary_device = comfy.model_management.get_torch_device()
                comfy.metrics.update_vram_metrics(primary_device)
