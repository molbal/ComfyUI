...
parser.add_argument("--enable-prometheus", action="store_true", help="Enable Prometheus metrics collection and register the endpoint.")
parser.add_argument("--prometheus-port", type=int, default=None, help="Optional integer port to run metrics on a separate server instance.")
